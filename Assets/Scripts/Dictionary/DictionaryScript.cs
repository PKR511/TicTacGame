...
public class DictionaryScript : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    [SerializeField]
    private List<TheamData> values = new List<TheamData>();

    private Dictionary<string, TheamData> myDictionary = new Dictionary<string, TheamData>();

    public bool modifyValues;

    public Dictionary<string, TheamData> MyDictionary { get => myDictionary; }
    ...
    public void DeserializeDictionary()
    {
        ...
        myDictionary = new Dictionary<string, TheamData>();
